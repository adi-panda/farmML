...
@app.route('/')
def home():
    return render_template('index.html', prediction_text="_____________")
...
def predict():
    ...
    a_description = prediction.getUser(request.form.get('description'))
    print(prediction.getUser(request.form.get('description')))
    print(a_description)
